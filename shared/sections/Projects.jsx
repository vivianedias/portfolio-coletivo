...
const PROJECTS_ITEMS = (t, locale) => [
	{
		...
		title: t("iana.title"),
		description: t("iana.description"),
		query: ["IAna"],
		link: "https://iana-chatbot.bonde.org/",
	},
	{
		img: {
			alt: t("fairshare.alt"),
			src: `/img/fairshare.png`,
		},
		title: t("fairshare.title"),
		description: t("fairshare.description"),
		query: ["Feminist Leadership Hub"],
		link: "https://www.feministleadershiphub.com/",
	},
	{
		img: {
			alt: t("noor.alt"),
